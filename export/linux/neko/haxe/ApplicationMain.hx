...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "EggDrop", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "EggDrop";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "EggDrop", null, { width: 640, height: 480 });
